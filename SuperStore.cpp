    ...
    while (1)
    {
        ...
        case 1:
            do
            {
                ...
                int quantity, amount;
                float price;
                cout << "Enter 1 to add new item to inventory" << endl
                     << "Enter 2 to remove any item from inventory" << endl
                     << "Enter 3 to change the price of any product" << endl
                     << "Enter 4 to change quantity of any product" << endl
                     << "Enter 5 to change both price and quantity of product" << endl
                     << "Enter 6 to go get product info" << endl
                     << "Enter 7 to go to super market menu" << endl;
                ...
                case 1:
                    ...
                    cin >> price;
                    cout << "\nEnter quantity of Product you want";
                    cin >> quantity;
                    cout << endl;
                ...
                case 2:
                    ...
                    break;
                case 3:
                    cout << "\nEnter the id of the product whose price you want to change";
                    cin >> pro_Id;
                ...
                case 4:
                    ...
                    cin >> pro_Id;
                    cout << "\nEnter 1 if you want to increase the stock or Enter 0 if you want to decrease it";
                    cin >> amount;
                    cout << endl;
                    if (amount == 1)
                    {
                        cout << "\nEnter the  quantity of atock that you want to increase";
                        cin >> quantity;
                        M.update_stock(pro_Id, quantity, amount);
                    }
                    else if (amount == 0)
                    {
                        cout << "\nEnter the  quantity of atock that you want to decrease";
                        cin >> quantity;
                        M.update_stock(pro_Id, quantity, amount);
                    }
                    else
                    ...
                    break;
                case 5:
                    cout << "\nEnter the id of the product whose quantity and price you want to change - ";
                    cin >> pro_Id;
                    cout << "\nEnter the new price of product - ";
                    cin >> price;
                    cout << "\nEnter 1 if you want to increase the stock or Enter 0 if you want to decrease it - ";
        ...
        case 2:
            ...
            do
            {
                ...
                cout << "Enter 2 for customer detail" << endl;
                cout << "Enter 3 to go to super market menu" << endl;
                cin >> cus_choice;
                switch (cus_choice)
                {
                case 1:
